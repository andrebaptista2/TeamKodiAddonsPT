...
elif action == 'kidszoneNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().kidszone()

elif action == 'areaZoneNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().areazone()

elif action == 'moviezoneNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().moviezone()

elif action == 'youtubeNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().youtubezone()
...
elif action == 'ChuckycollectionBox':
    from resources.lib.indexers import navigator
    navigator.navigator().ChuckycollectionBox()
