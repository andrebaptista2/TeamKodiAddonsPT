...
class indexer:
    ...
    def root(self):
        try:
            regex.clear()
            url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F786D6C732F316D656E752E786D6C'.decode('hex')
    ...
    def rootMC(self):
        try:
            regex.clear()
            url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F786D6C732F4D436C6973742E747874'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def chuckytube(self):
        try:
            regex.clear()
            url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F796F75747562652F79746D61696E6D792E747874'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def rootiptv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F706173746562696E2E636F6D2F7261772F714C3347374B62792F6D79697074762E6D3375'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def rootfluxtv(self):
        try:
            regex.clear()
            url = 'http://daanbanaan75.000webhostapp.com/xml-master/xmls/fluxtv.xml'
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def rootXXX(self):
        try:
            regex.clear()
            url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F75726C2F466C7578497074762F4C75737454762E747874'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def rootdeceit(self):
        try:
            regex.clear()
            url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F786D6C732F6465636569742E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
    ...
    def rootCustom(self):
        try:
            regex.clear()
            url = control.setting('customList')
            self.list = self.noname_list(url)
            for i in self.list:
                i.update({'content': 'addons'})
            self.addDirectory(self.list)
