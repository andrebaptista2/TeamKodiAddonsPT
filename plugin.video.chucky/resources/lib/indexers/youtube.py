...
class yt_index:  # initializes as Kids Corner, functions can override based on action and subid.
    def __init__(self):
        ...
        self.base_url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F796F75747562652F'.decode('hex')
    ...
    def init_vars(self, action):
        try:
            if action == 'fitness': 
                ...
                self.action   = 'legends'
                self.base_url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F6C6567656E64732F'.decode('hex')
		...
		self.action = 'mytube'
        	...
        	self.mainmenu = '%sytmainmy.txt' % (self.base_url)
                ...
                self.base_url = '68747470733A2F2F6461616E62616E61616E37352E303030776562686F73746170702E636F6D2F786D6C2D6D61737465722F746865637269746963732F'.decode('hex')
