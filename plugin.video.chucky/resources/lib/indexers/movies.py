...
class movies:
    def __init__(self):
        ...
        self.year_link = 'https://www.imdb.com/search/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&year=%s,%s&sort=moviemeter,asc&count=40&start=1'
	self.theatersOld_link = 'https://www.imdb.com/search/title?title_type=feature&num_votes=1000,&release_date=date[120],date[0]&sort=moviemeter,asc&count=40&start=1'
        self.fiftys_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1950-01-01,1959-12-31&user_rating=5.0,10.0'
        self.sixtys_link = 'https://www.imdb.com/search/title?title_type=feature&release_date=1960-01-01,1969-12-31&user_rating=5.0,10.0'
