...
ADDONTITLE     = '[B][COLOR yellow]Assistente Ares Milhano[/COLOR][/B]'
BUILDERNAME    = 'Milhano Build'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'repo.Milhano', 'My_Builds', 'backupdir']
BUILDFILE      = 'http://milhano.com.pt/wizard.menu.milhano/wizard1.txt'
UPDATECHECK    = 0
APKFILE        = 'http://milhano.com.pt/wizard.menu.milhano/wizard.apk.txt'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
ADDONFILE      = 'http://milhano.com.pt/wizard.menu.milhano/wizaddons.txt'
ADVANCEDFILE   = 'http://milhano.com.pt/wizard.menu.milhano/krypton%20advanced.txt'
ROMPACK        = 'http://milhano.com.pt/wizard.menu.milhano/rompack.txt'
EMUAPKS        = 'http://milhano.com.pt/wizard.menu.milhano/teamaddons.txt'
ADDONPACK      = 'http://'
...
WIZARDFILE     = 'http://milhano.com.pt/wizard.menu.milhano/wizard1.txt'
#########################################################
...
NOTIFICATION   = 'https://pastebin.com/raw/txPwX7FL'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = 'Ares Milhano Builds Wizard'
# url to image if using Image 424x180
HEADERIMAGE    = ''
# Font for Notification Window
FONTSETTINGS   = 'Font12'
# Background for Notification Window
BACKGROUND     = 'https://cld.pt/dl/download/8dfb4219-2213-4e6c-8976-aa7c46b9d963/fanart.jpg'
############################Milhano#############################