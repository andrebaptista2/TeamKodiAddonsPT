...
ADDONTITLE     = '[B][COLOR yellow]Assistente Ares Dream Team Wizard[/COLOR][/B]'
BUILDERNAME    = 'Ares Dream Team Wizard/Builds'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'repo.Milhano', 'My_Builds', 'backupdir']
BUILDFILE      = 'https://milhano.com.pt/wizard/wizard.builds.txt'
UPDATECHECK    = 0
APKFILE        = 'https://milhano.com.pt/wizard/wizard.apk.txt'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
ADDONFILE      = 'https://milhano.com.pt/wizard/wizard.addons.txt'
ADVANCEDFILE   = 'http://'
ROMPACK        = 'https://milhano.com.pt/wizard/rompack.txt'
EMUAPKS        = 'http://'
ADDONPACK      = 'http://'
...
WIZTITLE = 'Ares Dream Team Wizard'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Obrigado por usar o instalador Dream Team.'
...
WIZARDFILE     = 'https://milhano.com.pt/wizard/wizard.builds.txt'
#########################################################
...
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = 'Ares Dream Team Wizard/Builds '
