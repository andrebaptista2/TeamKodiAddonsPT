...
class navigator:
    ...
    def root(self):
       ...
       # self.addDirectoryItem(32002, 'tvNavigator', 'tvshows.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.channels') == False:
	...
	if self.getMenuEnabled('navi.youtube') == False:
	   self.addDirectoryItem('CollectionBox', 'MirrorcollectionBox', 'people-watching.png', 'DefaultMovies.png')
        ...
        if self.getMenuEnabled('navi.vipbox') == True:
            self.addDirectoryItem('VipBox', 'vipbox', 'vip.png', 'icon.gif')
	...
	self.addDirectoryItem(42006, 'searchNavigator', 'search.png', 'DefaultFolder.png')
 	if self.getMenuEnabled('navi.changeLog') == True:
            self.addDirectoryItem("News",  'ShowChangelog',  'icon.gif',  'fanart.jpg', isFolder=False)
...
##################################################################################################################################################################### 
	...
	if self.getMenuEnabled('navi.none') == False:
	    self.addDirectoryItem('Swift Streams', 'swiftNavigator', 'channels.png', '')
	    self.addDirectoryItem('Deceit', 'deceit', 'imdb.png', 'DefaultMovies.png', queue=True)
