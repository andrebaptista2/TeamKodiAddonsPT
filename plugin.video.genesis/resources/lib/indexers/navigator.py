...
class navigator:
    ...
    def tools(self):
        ...
        self.addDirectoryItem(30112, 'openSettings&query=3.1', 'settings.jpg', 'DefaultAddonProgram.png')
        self.addDirectoryItem(30113, 'openSettings&query=1.0', 'settings.jpg', 'DefaultAddonProgram.png')
        self.addDirectoryItem(30114, 'openSettings&query=6.0', 'settings.jpg', 'DefaultAddonProgram.png')
        self.addDirectoryItem(30118, 'openSettings&query=2.0', 'settings.jpg', 'DefaultAddonProgram.png')
